...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__cmodswig

#else
#  define SWIG_init    init_cmodswig

#endif
#define SWIG_name    "_cmodswig"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_null_func(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  
  if (!SWIG_Python_UnpackTuple(args, "null_func", 0, 0, 0)) SWIG_fail;
  null_func();
...
static PyMethodDef SwigMethods[] = {
	 { "null_func", _wrap_null_func, METH_NOARGS, NULL},
